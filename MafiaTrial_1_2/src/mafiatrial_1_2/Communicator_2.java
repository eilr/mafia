 ...
 * @author eilr__000
 */
public class Communicator_2 implements MessageListener {
    public static final String TOPIC01 = "jms/Topic02"; //sub
    public static final String TOPIC02 = "jms/Topic01"; //pub
    ...
    public static void main(String[] args) throws JMSException, NamingException, IOException{
        Communicator_2 comm2 = new Communicator_2();
        Context initialContext = comm2.getInitialContext();
        Topic topic01 = (Topic) initialContext.lookup(comm2.TOPIC01);
        Topic topic02 = (Topic) initialContext.lookup(comm2.TOPIC02);
        ...
        comm2.subscribe(topicConnection, topic02);
        comm2.publish(topicConnection, topic01);    
    }
